...
hyper:bind({}, 'k', nil, function()
  hs.application.launchOrFocus(os.getenv("HOME") .. '/.nix-profile/Applications/Visual Studio Code.app')
end)
...
hyper:bind({}, 'i', nil, function()
  hs.application.launchOrFocus(os.getenv("HOME") .. '/.nix-profile/Applications/iTerm2.app')
end)
