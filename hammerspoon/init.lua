...
hyper:bind({}, 'k', nil, function()
  hs.application.launchOrFocus(os.getenv("HOME") .. '/Applications/Nix/Visual Studio Code.app')
end)
...
hyper:bind({}, 'i', nil, function()
  hs.application.launchOrFocus(os.getenv("HOME") .. '/Applications/Nix/iTerm2.app')
end)
