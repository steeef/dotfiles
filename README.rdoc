...
* Steve Losh's dotfiles (http://github.com/sjl/dotfiles): Got a lot of great ideas from his vimrc and plugins
* Stick's vimfiles (http://github.com/stick/vimfiles): Great source of Puppet-specific changes
* Steve Losh's hgprompt (http://github.com/sjl/hgprompt): great utility for creating a bash prompt with hg repository info on it.
* Gina Trapani's todo.txt-cli (http://github.com/ginatrapani/todo.txt-cli): I use this tool to manage my own todo list in a text file. Very easy to use and powerful script.
