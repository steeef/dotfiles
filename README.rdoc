...
Also using sjl's fork of oh-my-zsh instead of Ryan's zsh config (http://github.com/sjl/oh-my-zsh).
I've removed the Mercurial prompt stuff, since I only use Git.
