...
I switched to using Pathogen to manage bundles instead of having
plugins spread across folders under the vim folder. You should be able
to run the following script to add bundles as submodules, init them if
necessary, and update all of them:

    bin/vim_update_bundles

Run this script from the directory you cloned to. If you followed the
above instructions, this should be ~/.dotfiles. Edit this script to
change the bundles you'd like to use.
