# Generated by Powerlevel10k configuration wizard on 2023-03-16 at 10:32 PDT.
...
source ~/.bin/set_catppuccin.sh macchiato
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=$CATPPUCCIN_SURFACE0
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$CATPPUCCIN_BLUE
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$CATPUCCIN_BLUE
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$CATPUCCIN_BLUE
